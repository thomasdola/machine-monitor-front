...
export const LOAD_REGIONS_SUCCESSFUL = "LOAD_REGIONS_SUCCESSFUL";
export const LOAD_REGIONS_FAILED = "LOAD_REGIONS_FAILED";
export const LOAD_DISTRICTS = "LOAD_DISTRICTS";
export const LOAD_DISTRICTS_SUCCESSFUL = "LOAD_DISTRICTS_SUCCESSFUL";
export const LOAD_DISTRICTS_FAILED = "LOAD_DISTRICTS_FAILED";
...
export const LOAD_CENTERS_SUCCESSFUL = "LOAD_CENTERS_SUCCESSFUL";
export const LOAD_CENTERS_FAILED = "LOAD_CENTERS_FAILED";
export const ADD_CENTER = "ADD_CENTER";
export const ADD_CENTER_SUCCESSFUL = "ADD_CENTER_SUCCESSFUL";
export const ADD_CENTER_FAILED = "ADD_CENTER_FAILED";
export const EDIT_CENTER = "EDIT_CENTER";
export const EDIT_CENTER_SUCCESSFUL = "EDIT_CENTER_SUCCESSFUL";
export const EDIT_CENTER_FAILED = "EDIT_CENTER_FAILED";
export const DELETE_CENTER = "DELETE_CENTER";
export const DELETE_CENTER_SUCCESSFUL = "DELETE_CENTER_SUCCESSFUL";
export const DELETE_CENTER_FAILED = "DELETE_CENTER_FAILED";
