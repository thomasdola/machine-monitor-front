...
import PWrapper from "./PoliciesBox";
import {Motion, spring} from "react-motion";
import {Intent} from "@blueprintjs/core";
import {EDIT_ROLE_WITH_POLICIES} from "../../../helpers/constants";
...
class AvailablePolicies extends React.Component {
    ...
    componentDidUpdate(prevProps){
        ...
        if(!_isEqual(OLD_OPERATION_SUCCESSFUL, OPERATION_SUCCESSFUL)){
            if(OPERATION_SUCCESSFUL.action === EDIT_ROLE_WITH_POLICIES){
                Toaster.show({
        ...
        if(!_isEqual(OLD_OPERATION_FAILED, OPERATION_FAILED)){
            if(OPERATION_FAILED.action === EDIT_ROLE_WITH_POLICIES){
    ...
    _handleAddPolicyToGroup = (policies) => {
        ...
        let policiesIds = policies.map(({id}) => id);
